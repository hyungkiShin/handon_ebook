...
function next_animateR(){clear_canvas();var percent=AniObj.transPercent[AniObj.seq];var smwidth=ScreenInfo.smImageWidth*(1-percent);var skewh=100/smwidth*percent;if(SmcObj.drawR===1){cntx.save();cntx.fillStyle=ScreenInfo.blankColor;cntx.setTransform(1,-skewh,0,1,0,0);cntx.fillRect(AniObj.baseX,smRect.y+AniObj.baseX*skewh,smwidth,ScreenInfo.smImageHeight);cntx.restore();}
else{cntx.save();cntx.setTransform(1,-skewh,0,1,0,0);cntx.drawImage(catImageRN,AniObj.baseX,smRect.y+AniObj.baseX*skewh,smwidth,ScreenInfo.smImageHeight);cntx.restore();}
...
function next_animateL(){clear_canvas();var percent=AniObj.transPercent[AniObj.seq];var smwidth=ScreenInfo.smImageWidth*percent;var skewh=100/smwidth*(1-percent);var smx=AniObj.baseX+ScreenInfo.smImageWidth*(1-percent);if(SmcObj.drawL===1){cntx.save();cntx.setTransform(1,skewh,0,1,0,0);cntx.fillStyle=ScreenInfo.blankColor;cntx.fillRect(smx,smRect.y-(smx+smwidth)*skewh,smwidth,ScreenInfo.smImageHeight);cntx.restore();}
else{cntx.save();cntx.setTransform(1,skewh,0,1,0,0);cntx.drawImage(catImageLN,smx,smRect.y-(smx+smwidth)*skewh,smwidth,ScreenInfo.smImageHeight);cntx.restore();}
AniObj.seq++;if(AniObj.seq===AniObj.transLen){clearInterval(AniObj.timer);SmcObj.load_leftImageEach('next');}}
function next_animateLone(){clear_canvas();var percent=AniObj.transPercent[AniObj.seq];var smwidth=ScreenInfo.smImageWidth*percent;var skewh=100/smwidth*(1-percent);var smx=AniObj.baseX+ScreenInfo.smImageWidth*(1-percent);cntx.globalAlpha=1-percent;if(SmcObj.drawL===1){cntx.save();cntx.setTransform(1,skewh,0,1,0,0);cntx.fillStyle=ScreenInfo.blankColor;cntx.fillRect(smx,smRect.y-(smx+smwidth)*skewh,smwidth,ScreenInfo.smImageHeight);cntx.restore();}
else{cntx.save();cntx.setTransform(1,skewh,0,1,0,0);cntx.drawImage(catImageLN,smx,smRect.y-(smx+smwidth)*skewh,smwidth,ScreenInfo.smImageHeight);cntx.restore();}
...
function prev_animateL(){clear_canvas();var percent=AniObj.transPercent[AniObj.seq];var smwidth=ScreenInfo.smImageWidth*(1-percent);var skewh=100/smwidth*percent;var smx=AniObj.baseX+ScreenInfo.smImageWidth*percent;if(SmcObj.drawL===1){cntx.save();cntx.setTransform(1,skewh,0,1,0,0);cntx.fillStyle=ScreenInfo.blankColor;cntx.fillRect(smx,smRect.y-(smx+smwidth)*skewh,smwidth,ScreenInfo.smImageHeight);cntx.restore();}
else{cntx.save();cntx.setTransform(1,skewh,0,1,0,0);cntx.drawImage(catImageLN,smx,smRect.y-(smx+smwidth)*skewh,smwidth,ScreenInfo.smImageHeight);cntx.restore();}
...
function prev_animateLone(){clear_canvas();var percent=AniObj.transPercent[AniObj.seq];var smwidth=ScreenInfo.smImageWidth*(1-percent);var skewh=100/smwidth*percent;var smx=AniObj.baseX+ScreenInfo.smImageWidth*percent;if(SmcObj.drawL===1){cntx.save();cntx.setTransform(1,skewh,0,1,0,0);cntx.fillStyle=ScreenInfo.blankColor;cntx.fillRect(AniObj.baseX+ScreenInfo.smImageWidth*percent,smRect.y,ScreenInfo.smImageWidth*(1-percent),ScreenInfo.smImageHeight);cntx.restore();}
else{cntx.save();cntx.setTransform(1,skewh,0,1,0,0);cntx.drawImage(catImageLN,smx,smRect.y-(smx+smwidth)*skewh,smwidth,ScreenInfo.smImageHeight);cntx.restore();}
...
function prev_animateR(){clear_canvas();var percent=AniObj.transPercent[AniObj.seq];var smwidth=ScreenInfo.smImageWidth*percent;var skewh=100/smwidth*(1-percent);if(SmcObj.drawR===1){cntx.fillStyle=ScreenInfo.blankColor;cntx.fillRect(AniObj.baseX,smRect.y,ScreenInfo.smImageWidth*percent,ScreenInfo.smImageHeight);}
else{cntx.save();cntx.setTransform(1,-skewh,0,1,0,0);cntx.drawImage(catImageRN,AniObj.baseX,smRect.y+AniObj.baseX*skewh,smwidth,ScreenInfo.smImageHeight);cntx.restore();}
AniObj.seq++;if(AniObj.seq===AniObj.transLen){clearInterval(AniObj.timer);SmcObj.load_rightImageEach('prev');}}
function prev_animateRone(){clear_canvas();var percent=AniObj.transPercent[AniObj.seq];var smwidth=ScreenInfo.smImageWidth*percent;var skewh=100/smwidth*(1-percent);cntx.globalAlpha=1-percent;if(SmcObj.drawR===1){cntx.fillStyle=ScreenInfo.blankColor;cntx.fillRect(AniObj.baseX,smRect.y,ScreenInfo.smImageWidth*percent,ScreenInfo.smImageHeight);}
else{cntx.save();cntx.setTransform(1,-skewh,0,1,0,0);cntx.drawImage(catImageRN,AniObj.baseX,smRect.y+AniObj.baseX*skewh,smwidth,ScreenInfo.smImageHeight);cntx.restore();}
